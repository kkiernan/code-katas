...
class RomanNumeralsConverterSpec extends ObjectBehavior {
	...
	{
		$this->shouldHaveType('Acme\RomanNumeralsConverter');
	}
	...
	function it_calculates_the_roman_numeral_for_800()
	{
	...
	function it_calculates_the_roman_numeral_for_3956()
	{
		$this->convert(3956)->shouldReturn('MMMCMLVI');
	}
